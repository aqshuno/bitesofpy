...
def get_workout_motd(day):
    ...
    """
    normalizedDay = day.title()
    if normalizedDay not in WORKOUT_SCHEDULE:
        return INVALID_DAY
    else:
        typeTrain = WORKOUT_SCHEDULE[normalizedDay]
        return CHILL_OUT if  typeTrain == REST else TRAIN.format(typeTrain)